...
//
//
//    packet_v = (AVPacket *) av_malloc(sizeof(AVPacket));
//    av_init_packet(packet_v);
//
...
//            while (true) {
//                if (av_read_frame(pFormatCtx, packet_v) < 0) {
//                    thread_exit = true;
//                }
//                if (packet_v->stream_index == videoStreamIndex) {
//                    break;
//                }
//            }
//
//            if (packet_v->stream_index == videoStreamIndex) {
//                avcodec_send_packet(pCodecCtx, packet_v);
